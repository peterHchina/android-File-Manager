...
import org.swift.ftp.ProxyConnector;
import org.swift.ftp.SessionThread;
import org.swift.ftp.TcpListener;
import org.swift.ftp.UiUpdater;

import com.example.managerfile.ui.FileManagerTabActivity;
import com.example.managerfile.util.FileUtil;
import com.example.managerfile.util.GlobalConsts;
...
public class FTPServerService extends Service implements Runnable {
    ...
    public void onStart(Intent intent, int startId) {
        ...
        while (serverThread != null) {
            ...
            if (attempts > 0) {
                attempts--;
                FileUtil.sleepIgnoreInterupt(1000);
            } else {
    ...
    private void setupNotification() {
        ...
        Intent notificationIntent = new Intent(this, FileManagerTabActivity.class);
    ...
    public static InetAddress getWifiIp() {
        ...
        if (isWifiEnabled()) {
            ...
            if (ipAsInt == 0) {
                ...
                return FileUtil.intToInet(ipAsInt);
            }
        } else {
            return null;
        }
