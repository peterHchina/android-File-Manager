...
public final class CameraManager
{
	...
	public void openDriver(SurfaceHolder holder) throws IOException
	{
		if (camera == null)
		{
			...
			/*
			 * mParameters = camera.getParameters(); String flashMode =
			 * Camera.Parameters.FLASH_MODE_TORCH; if (flashMode != null) {
	...
	public Rect getFramingRect()
	{
		...
		if (framingRect == null)
		{
			...
			Resources res = context.getResources();
		      int width = res.getDimensionPixelSize(R.dimen.preview_Width);
		      int offset=res.getDimensionPixelSize(R.dimen.preview_view_to_top);
		      int height = res.getDimensionPixelSize(R.dimen.preview_Height);
		      int leftOffset = (screenResolution.x - width) / 2;
		      int topOffset = (screenResolution.y - height) / 2 -offset;
