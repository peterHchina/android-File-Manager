...
public class CollectFileListAdapter extends BaseAdapter
{
	...
	public List<DetailCategoryFileinfo> listItems = new ArrayList<DetailCategoryFileinfo>();
	int phSize;
	...
	public CollectFileListAdapter(Context context, List<DetailCategoryFileinfo> objects)
	{
		listItems = objects;
		mContext = context;
	...
	public View getView(int position, View convertview, ViewGroup parent)
	{
		...
		DetailCategoryFileinfo mFileMap = listItems.get(position);
	...
	private View fillInApkIconView(View convertview, DetailCategoryFileinfo map, int postion)
	{
		viewHolder holder;
		if (convertview == null) {
	...
	private View fillInPicView(View convertview, DetailCategoryFileinfo map, int postion)
	{
		viewHolder holder;
		if (convertview == null) {
			LayoutInflater inflater = LayoutInflater.from(mContext);
		...
		if (map.isDrectory()) {
			holder.mFileCount.setVisibility(View.VISIBLE);
			holder.mFileCount.setText(String.format(mfolderFormate, map.getNumber()));
		}
		else {
			holder.mFileCount.setVisibility(View.GONE);
		}
	...
	private View fillInNotPicView(View convertview, DetailCategoryFileinfo map, int postion)
	{
		viewHolder holder;
		if (convertview == null) {
	...
	{
		DetailCategoryFileinfo map = listItems.get(paramInt);
		String filename = map.getPath();
	...
	public List<DetailCategoryFileinfo> GetCheckItems()
	{
		List<DetailCategoryFileinfo> mList = new ArrayList<DetailCategoryFileinfo>();
		for (int i = 0; i < listItems.size(); i++) {
