...
public class PasteGridAdapter extends BaseAdapter
{

	private Context mContext;
	List<Fileinfo> listItems = new ArrayList<Fileinfo>();
	int phSize;
	...
	public PasteGridAdapter(Context context, List<Fileinfo> objects)
	{
		listItems = objects;
		mContext = context;
	...
	private View fillInPicView(View convertview, Fileinfo map, int postion)
	{
		...
		if (convertview == null)
		{
			...
			convertview = inflater.inflate(R.layout.paste_grid_item, null);
