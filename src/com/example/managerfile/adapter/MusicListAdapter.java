...
public class MusicListAdapter extends BaseAdapter
{
	...
	public List<Musicinfo> listItems = new ArrayList<Musicinfo>();
	int phSize;
	...
	public MusicListAdapter(Context context, List<Musicinfo> objects, LinearLayout layout)
	{
		listItems = objects;
		mContext = context;
	...
	public View getView(int position, View convertview, ViewGroup parent)
	{
		...
		Musicinfo mFileMap = listItems.get(position);
	...
	private View fillInPicView(View convertview, Musicinfo map, int postion)
	{
		viewHolder holder;
		if (convertview == null) {
	...
	private View fillInNotPicView(View convertview, Musicinfo map, int postion)
	{
		viewHolder holder;
		if (convertview == null) {
	...
	{
		Musicinfo map = listItems.get(paramInt);
		String filename = map.getTitle();
	...
	public List<Musicinfo> GetCheckItems()
	{
