...
public class ImageListAdapter extends BaseAdapter
{
	...
	public List<Imageinfo> listItems = new ArrayList<Imageinfo>();
	int phSize;
	...
	public ImageListAdapter(Context context, List<Imageinfo> objects,LinearLayout layout)
	{
		listItems = objects;
		mContext = context;
	...
	public View getView(int position, View convertview, ViewGroup parent)
	{
		...
		Imageinfo mFileMap = listItems.get(position);
	...
	private View fillInPicView(View convertview, Imageinfo map, int postion)
	{
		viewHolder holder;
		if (convertview == null) {
	...
	private View fillInNotPicView(View convertview, Imageinfo map, int postion)
	{
		viewHolder holder;
		if (convertview == null) {
	...
	{
		Imageinfo map = listItems.get(paramInt);
	...
	public List<Imageinfo> GetCheckItems()
	{
